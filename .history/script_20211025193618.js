...
const car_options = class_select.querySelectorAll('option');//dodać zmianę do funkcji getElements
...
TODO: //wywala te funkcje ze względu na type="module" CHECK!!!!!
// może po prostu dodać evenlistnera do selectów i funkcje w callbacku?
...
class_select.addEventListener('onchange', selectCars);
extraSelect.addEventListener('onchange', selectExtra);
